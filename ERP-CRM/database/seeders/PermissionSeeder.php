...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $modules = [
            ...
            'purchase_requests' => ['view', 'create', 'edit', 'delete', 'export'],
            'supplier_quotations' => ['view', 'create', 'edit', 'delete', 'export'],
            'supplier_price_lists' => ['view', 'create', 'edit', 'delete', 'export'],
            'shipping_allocations' => ['view', 'create', 'edit', 'delete', 'export'],
            'purchase_reports' => ['view', 'export'],
            'work_schedules' => ['view', 'create', 'edit', 'delete'],
    ...
    private function translatePermissionDescription(string $action, string $module): string
    {
        ...
        $moduleMap = [
            ...
            'opportunities' => 'cơ hội',
            'activities' => 'công việc',
            'customer_care_stages' => 'chăm sóc khách hàng',
            'projects' => 'dự án',
            ...
            'supplier_price_lists' => 'bảng giá nhà cung cấp',
            'shipping_allocations' => 'phân bổ vận chuyển',
            'purchase_reports' => 'báo cáo mua hàng',
            'work_schedules' => 'lịch làm việc',
            'approval_workflows' => 'quy trình duyệt',
