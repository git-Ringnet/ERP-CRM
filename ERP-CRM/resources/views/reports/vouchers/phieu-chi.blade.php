...
<head>
    <meta charset="UTF-8">
    <title>Phiếu Chi - {{ $transaction->reference_number ?? $transaction->id }}</title>
    <style>
...
<body>
    <div class="no-print" style="margin-bottom: 20px; text-align: center;">
        <button onclick="window.print()" style="padding: 10px 20px; cursor: pointer;">In Phiếu Chi</button>
    </div>
    ...
    <div class="title">
        ...
        <p>Quyển số: ....................<br>Số: {{ $transaction->reference_number ?? ('PC-'.str_pad($transaction->id, 5, '0', STR_PAD_LEFT)) }}</p>
        <p>Nợ: {{ $transaction->category->misa_code ?? '642' }}<br>Có: 1111</p>
    </div>

    <div class="content">
        <div class="content-row">
            <span class="label">Họ và tên người nhận tiền:</span>
