    ...
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('supplier-quotations.import') }}"
                    class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
                    <i class="fas fa-file-import mr-2"></i> Import Excel
                </a>
                <a href="{{ route('supplier-quotations.create') }}"
                                    ...
                                    <div class="flex items-center justify-center space-x-1">
                                        ...
                                        @if($quotation->status == 'pending')
                                            ...
                                            <form action="{{ route('supplier-quotations.reject', $quotation) }}" method="POST"
                                                ...
                                                <button type="submit"
                                                    ...
                                                    title="Từ chối" onclick="return confirm('Từ chối báo giá này?')">
                                        ...
                                        @if($quotation->status !== 'selected')
                                            <form action="{{ route('supplier-quotations.destroy', $quotation) }}" method="POST"
                                                class="inline" onsubmit="return confirm('Bạn có chắc chắn muốn xóa báo giá này?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="inline-flex items-center justify-center w-8 h-8 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200"
                                                    title="Xóa">
