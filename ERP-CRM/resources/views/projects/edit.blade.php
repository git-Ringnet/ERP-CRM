                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status" required
                            ...
                            <option value="planning" {{ old('status', $project->status) == 'planning' ? 'selected' : '' }}>Lên
                                kế hoạch</option>
                            ...
                            <option value="completed" {{ old('status', $project->status) == 'completed' ? 'selected' : '' }}>
                                Hoàn thành</option>
                            <option value="on_hold" {{ old('status', $project->status) == 'on_hold' ? 'selected' : '' }}>Tạm
                                dừng</option>
                    ...
                    <div class="bg-white rounded-lg shadow-sm">
                        ...
                        <div class="p-4">
                            <label for="budget" class="block text-sm font-medium text-gray-700 mb-1">Dự toán / Ngân sách
                                (VNĐ)</label>
                            <input type="text" id="budget_display" oninput="formatCurrency(this)" value="{{ number_format(old('budget', $project->budget)) }}"
                                class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-primary focus:border-primary">
