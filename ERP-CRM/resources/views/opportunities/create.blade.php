                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                        ...
                        <div class="space-y-4">
                            ...
                            <div id="technical_user_wrap" class="{{ old('needs_technical') ? '' : 'hidden' }}">
                                <input type="hidden" name="technical_user_id" id="technical_user_id" value="{{ old('technical_user_id', $technicalManagerId ?? '') }}">
