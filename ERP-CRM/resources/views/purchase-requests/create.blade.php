...
@section('content')
    <div class="bg-white rounded-lg shadow-sm">
        ...
        <form action="{{ route('purchase-requests.store') }}" method="POST" id="requestForm" class="p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Mã yêu cầu <span
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required
                        placeholder="VD: Yêu cầu báo giá thiết bị văn phòng"
            ...
            <!-- Chọn NCC -->
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">Chọn nhà cung cấp gửi yêu cầu <span
                        class="text-red-500">*</span></label>
                    ...
                    <div
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="items[0][unit]" value="Cái"
                                class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 item-unit">
                        </div>
                        ...
                        <div class="col-span-1 flex justify-center">
                            <button type="button"
                                class="remove-item w-8 h-8 bg-red-100 text-red-600 rounded-lg hover:bg-red-200"
                                style="display:none;">
            ...
            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                <a href="{{ route('purchase-requests.index') }}"
                    class="px-4 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50">Hủy</a>
    ...
    @push('styles')
        ...
        <style>
            /* TomSelect for Suppliers (Multiple) */
