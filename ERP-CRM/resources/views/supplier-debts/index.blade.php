...
@section('page-title', 'Công nợ nhà cung cấp')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm text-gray-500">NCC có công nợ</p>
                        <p class="text-2xl font-bold text-gray-800">
                            {{ number_format($summary['total_suppliers_with_debt']) }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                <div class="flex-1 min-w-[200px]">
                    ...
                    <input type="text" name="search" value="{{ $search }}" placeholder="Tên, mã NCC, SĐT..."
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('supplier-debts.export') }}"
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Mã NCC</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tên NCC</th>
                            ...
                            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">PO chưa TT</th>
