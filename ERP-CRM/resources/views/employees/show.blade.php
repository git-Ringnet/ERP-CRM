        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('employees.salary-setup', $employee->id) }}" 
                       class="w-full inline-flex items-center justify-center px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg transition-colors">
                        <i class="fas fa-file-invoice-dollar mr-2"></i>Cấu hình Lương & Phụ cấp
                    </a>
