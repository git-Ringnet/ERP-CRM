        ...
        <script>
            ...
            function addItem(existingData = null) {
                ...
                <p id="serialInfo_${itemIndex}" class="text-xs text-gray-500">
                    <i class="fas fa-info-circle mr-1"></i>Đang tải thông tin serial...
                </p>
            `;
                ...
                // If editing existing data, set the unit in dataset
                if (existingData) {
                    const idInput = itemDiv.querySelector('.product-id-input');
                    if (idInput) {
                        idInput.dataset.unit = existingData.unit || 'đv';
                    }
                }
            ...
            function updateSummary() {
                ...
                itemCards.forEach((card, idx) => {
                    ...
                    const productUnit = productIdInput.dataset.unit || 'đv';
