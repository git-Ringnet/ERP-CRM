...
@section('content')
    <div x-data="dashboardApp()" x-init="init()" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
            <form method="GET" action="{{ route('dashboard.business-activity') }}" id="filterForm"
            ...
            <div class="metrics-grid">
                ...
                <div class="metric-card">
                    ...
                    @if($metrics['revenue']['growth_rate'] !== null)
                        <div class="flex items-center mt-2">
                            <span
                                class="text-xs {{ $metrics['revenue']['trend'] === 'up' ? 'growth-positive' : ($metrics['revenue']['trend'] === 'down' ? 'growth-negative' : 'growth-neutral') }}">
                                <i
                                    class="fas fa-{{ $metrics['revenue']['trend'] === 'up' ? 'arrow-up' : ($metrics['revenue']['trend'] === 'down' ? 'arrow-down' : 'minus') }} mr-1"></i>
                ...
                <div class="metric-card">
                    ...
                    @if($metrics['profit']['growth_rate'] !== null)
                        <div class="flex items-center mt-2">
                            <span
                                class="text-sm {{ $metrics['profit']['trend'] === 'up' ? 'growth-positive' : ($metrics['profit']['trend'] === 'down' ? 'growth-negative' : 'growth-neutral') }}">
                                <i
                                    class="fas fa-{{ $metrics['profit']['trend'] === 'up' ? 'arrow-up' : ($metrics['profit']['trend'] === 'down' ? 'arrow-down' : 'minus') }} mr-1"></i>
                ...
                <div class="metric-card">
                    ...
                    @if($metrics['purchase_cost']['growth_rate'] !== null)
                        <div class="flex items-center mt-2">
                            <span
                                class="text-sm {{ $metrics['purchase_cost']['trend'] === 'up' ? 'growth-positive' : ($metrics['purchase_cost']['trend'] === 'down' ? 'growth-negative' : 'growth-neutral') }}">
                                <i
                                    class="fas fa-{{ $metrics['purchase_cost']['trend'] === 'up' ? 'arrow-up' : ($metrics['purchase_cost']['trend'] === 'down' ? 'arrow-down' : 'minus') }} mr-1"></i>
                ...
                <div class="metric-card">
                    ...
                    @if($metrics['sales_count']['growth_rate'] !== null)
                        <div class="flex items-center mt-2">
                            <span
                                class="text-sm {{ $metrics['sales_count']['growth_rate'] > 0 ? 'growth-positive' : ($metrics['sales_count']['growth_rate'] < 0 ? 'growth-negative' : 'growth-neutral') }}">
                                <i
                                    class="fas fa-{{ $metrics['sales_count']['growth_rate'] > 0 ? 'arrow-up' : ($metrics['sales_count']['growth_rate'] < 0 ? 'arrow-down' : 'minus') }} mr-1"></i>
                ...
                <div class="metric-card">
                    ...
                    @if($metrics['purchase_orders_count']['growth_rate'] !== null)
                        <div class="flex items-center mt-2">
                            <span
                                class="text-sm {{ $metrics['purchase_orders_count']['growth_rate'] > 0 ? 'growth-positive' : ($metrics['purchase_orders_count']['growth_rate'] < 0 ? 'growth-negative' : 'growth-neutral') }}">
                                <i
                                    class="fas fa-{{ $metrics['purchase_orders_count']['growth_rate'] > 0 ? 'arrow-up' : ($metrics['purchase_orders_count']['growth_rate'] < 0 ? 'arrow-down' : 'minus') }} mr-1"></i>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100" x-data="{ activeFilter: 'all' }">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3 mb-6">
                        ...
                        <button @click="activeFilter = activeFilter === 'ordered' ? 'all' : 'ordered'"
                            ...
                            <div class="text-2xl font-bold text-blue-700">{{ $order_overview['status_counts']['ordered'] ?? 0 }}
                            </div>
                        ...
                        <button @click="activeFilter = activeFilter === 'hold' ? 'all' : 'hold'"
                            ...
                            <div class="text-2xl font-bold text-orange-700">{{ $order_overview['status_counts']['hold'] ?? 0 }}
                            </div>
                        ...
                        <button @click="activeFilter = activeFilter === 'received' ? 'all' : 'received'"
                            ...
                            <div class="text-2xl font-bold text-emerald-700">{{ $order_overview['status_counts']['received'] ?? 0 }}
                            </div>
                        ...
                        <button @click="activeFilter = activeFilter === 'invoiced' ? 'all' : 'invoiced'"
                            ...
                            <div class="text-2xl font-bold text-amber-700">{{ $order_overview['status_counts']['invoiced'] ?? 0 }}
                            </div>
                        ...
                        <button @click="activeFilter = activeFilter === 'completed' ? 'all' : 'completed'"
                            ...
                            <div class="text-2xl font-bold text-green-700">{{ $order_overview['status_counts']['completed'] ?? 0 }}
                            </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($order_overview['orders'] as $order)
                                    <tr x-show="activeFilter === 'all' || activeFilter === '{{ $order['dashboard_status'] }}'"
                                        x-transition:enter="transition ease-out duration-200" class="hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <div class="flex items-center gap-1.5">
                                                    <span
                                                        class="text-[10px] font-bold uppercase tracking-wider {{ $isHold ? 'text-orange-600' : 'text-gray-500' }}">
                                                ...
                                                @if($isHold && $order['hold_reason'])
                                                    <div class="text-[9px] text-orange-600 font-medium mt-0.5 max-w-[150px] truncate"
                                        ...
                                        <td class="px-3 py-2 text-sm">
                                            @if($order['po_code'])
                                                <a href="{{ route('purchase-orders.show', $order['po_id']) }}"
                                        ...
                                        <thead class="bg-gray-50">
                                            <tr>
                                                <th scope="col" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                                                    Sản phẩm</th>
                                                <th scope="col"
                                                    class="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">SL</th>
                                                <th scope="col"
                                                    class="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Doanh thu
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <thead class="bg-gray-50">
                                            <tr>
                                                <th scope="col" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                                                    Khách hàng</th>
                                                <th scope="col"
                                                    class="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Đơn hàng
                                                </th>
                                                <th scope="col"
                                                    class="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Doanh thu
                                                </th>
                        ...
                        @if(isset($sales_analysis['payment_status_distribution']) && count($sales_analysis['payment_status_distribution']) > 0)
                            <div>
                                ...
                                <div class="chart-container" style="height: 300px;">
                                    <canvas id="paymentStatusChart" role="img"
                                        aria-label="Biểu đồ phân bố trạng thái thanh toán"></canvas>
                                </div>
                            </div>
                        @endif
                    </div>
                                        ...
                                        <thead class="bg-gray-50">
                                            <tr>
                                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">
                                                    Nhà cung cấp</th>
                                                <th scope="col"
                                                    class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Đơn hàng
                                                </th>
                                                <th scope="col"
                                                    class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Chi phí
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <thead class="bg-gray-50">
                                            <tr>
                                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">
                                                    Sản phẩm</th>
                                                <th scope="col"
                                                    class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Số lượng
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="top-performers-table overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Sản
                                                phẩm</th>
                                            <th scope="col" class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Số
                                                lượng</th>
                                            <th scope="col" class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Giá
                                                trị</th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
        ...
        <div x-show="showExportModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
            role="dialog" aria-modal="true" @keydown.escape.window="showExportModal = false">
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form method="POST" action="{{ route('dashboard.business-activity.export') }}"
                                        id="exportForm">
                                        @csrf
                                        <div class="space-y-3">
                                            <label
