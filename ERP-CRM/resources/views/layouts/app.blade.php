            ...
            <nav class="mt-4 px-2">
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('activities.index') }}"
                        class="hidden flex items-center px-4 py-3 text-gray-300 hover:bg-primary hover:text-white rounded-lg transition-colors {{ request()->routeIs('activities.*') ? 'bg-primary text-white' : '' }}">
