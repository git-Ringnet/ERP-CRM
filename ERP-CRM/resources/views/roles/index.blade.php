...
<div class="bg-white rounded-lg shadow-sm">
    ...
    <div class="p-4 border-b border-gray-200 flex justify-between items-center">
        <div></div>
        @can('create_roles')
        <a href="{{ route('roles.create') }}" class="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-lg text-sm flex items-center gap-2">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">{{ $role->permissions->count() }}</span>
                    </td>
                    <td class="px-4 py-3">
                        <div class="flex gap-3">
                            @can('edit_roles')
                            <a href="{{ route('roles.edit', $role->id) }}" class="text-yellow-600 hover:text-yellow-900 text-sm">
