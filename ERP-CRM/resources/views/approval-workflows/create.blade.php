        ...
        <div class="bg-white rounded-lg shadow-sm mb-6">
            ...
            <div class="p-6" id="levelsContainer">
                ...
                <div class="level-item bg-gray-50 p-4 rounded-lg mb-4 relative">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tên cấp duyệt <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="levels[0][name]" required placeholder="VD: Trưởng phòng"
                                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Loại người duyệt <span
                                    class="text-red-500">*</span></label>
                            <select name="levels[0][approver_type]" required
                                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Người duyệt <span
                                    class="text-red-500">*</span></label>
                            <select name="levels[0][approver_value]" required
                                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="level-item bg-gray-50 p-4 rounded-lg mb-4 relative">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Loại người duyệt <span
                                    class="text-red-500">*</span></label>
                            <select name="levels[1][approver_type]" required
                                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="role">Theo vai trò</option>
                                <option value="user">Người dùng cụ thể</option>
                            </select>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Người duyệt <span
                                    class="text-red-500">*</span></label>
                            <select name="levels[1][approver_value]" required
                                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Chọn...</option>
                                <option value="manager">Vai trò: Trưởng phòng</option>
                                <option value="director">Vai trò: Giám đốc</option>
