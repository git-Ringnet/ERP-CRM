        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="VD: Quy trình duyệt báo giá"
                ...
                <div>
                    ...
                    <select name="document_type" required class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="2" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description') }}</textarea>
                </div>
                <div>
    ...
    <div class="bg-white rounded-lg shadow-sm mb-6">
        ...
        <div class="p-6" id="levelsContainer">
                ...
                <div class="level-item bg-gray-50 p-4 rounded-lg mb-4 relative">
                    ...
                    <h5 class="font-semibold mb-3 text-blue-600">Cấp 1</h5>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tên cấp duyệt <span class="text-red-500">*</span></label>
                            <input type="text" name="levels[0][name]" required placeholder="VD: Trưởng phòng"
                        ...
                        <div>
                            ...
                            <select name="levels[0][approver_type]" required class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <select name="levels[0][approver_value]" required class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="number" name="levels[0][min_amount]" min="0" placeholder="Không giới hạn"
                                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="level-item bg-gray-50 p-4 rounded-lg mb-4 relative">
                    ...
                    <h5 class="font-semibold mb-3 text-blue-600">Cấp 2</h5>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tên cấp duyệt <span class="text-red-500">*</span></label>
                            <input type="text" name="levels[1][name]" required placeholder="VD: Giám đốc"
                                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Loại người duyệt <span class="text-red-500">*</span></label>
                            <select name="levels[1][approver_type]" required class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="role">Theo vai trò</option>
                                <option value="user">Người dùng cụ thể</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Người duyệt <span class="text-red-500">*</span></label>
                            <select name="levels[1][approver_value]" required class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Chọn...</option>
                                <option value="manager">Vai trò: Trưởng phòng</option>
                                <option value="director">Vai trò: Giám đốc</option>
                                <option value="accountant">Vai trò: Kế toán</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Giá trị tối thiểu</label>
                            <input type="number" name="levels[1][min_amount]" min="0" placeholder="Không giới hạn"
                                class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
...
function addLevel() {
    ...
    div.innerHTML = `
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Tên cấp duyệt <span class="text-red-500">*</span></label>
                <input type="text" name="levels[${levelIndex}][name]" required placeholder="VD: Pháp chế"
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Loại người duyệt <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Giá trị tối thiểu</label>
                <input type="number" name="levels[${levelIndex}][min_amount]" min="0" placeholder="Không giới hạn"
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
        </div>
    `;
