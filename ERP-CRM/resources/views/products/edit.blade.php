                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="code" id="code" value="{{ old('code', $product->code) }}" required placeholder="VD: SP001"
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $product->name) }}" required placeholder="Nhập tên sản phẩm"
