        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ number_format($summary['total_customers_with_debt']) }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-orange-600">{{ number_format($summary['total_overdue'], 0, ',', '.') }}đ</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-4">
        <form method="GET" class="flex flex-wrap gap-4 items-end">
            ...
            <div class="w-48">
                ...
                <select name="debt_status" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('customer-debts.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-sm text-right text-gray-900">{{ number_format($customer->total_sales, 0, ',', '.') }}</td>
                        <td class="px-4 py-3 text-sm text-right text-green-600">{{ number_format($customer->total_paid, 0, ',', '.') }}</td>
                        <td class="px-4 py-3 text-sm text-right font-medium {{ $customer->total_debt > 0 ? 'text-red-600' : 'text-gray-600' }}">
                            {{ number_format($customer->total_debt, 0, ',', '.') }}
                        </td>
                        <td class="px-4 py-3 text-sm text-right {{ $customer->debt_limit > 0 && $customer->total_debt > $customer->debt_limit ? 'text-orange-600 font-medium' : 'text-gray-600' }}">
