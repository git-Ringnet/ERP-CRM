...
@section('page-title', 'Nhật ký Kiểm toán')
    ...
    <div class="p-4 border-b border-gray-200">
        <form action="{{ route('audit-logs.index') }}" method="GET">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
                <div>
                    <label for="date_from" class="block text-xs font-medium text-gray-700 mb-1">Từ ngày</label>
                    <input type="date" 
                ...
                <div>
                    <label for="date_to" class="block text-xs font-medium text-gray-700 mb-1">Đến ngày</label>
                    <input type="date" 
                           class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" 
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('audit-logs.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm flex items-center gap-2">
