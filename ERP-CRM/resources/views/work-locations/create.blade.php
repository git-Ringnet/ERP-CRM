...
@section('title', 'Thêm Địa điểm làm việc')
@section('page-title', 'Thêm Địa điểm làm việc')

@section('content')
<div class="">
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Thông tin địa điểm</h2>
            <a href="{{ route('work-locations.index') }}" class="text-gray-500 hover:text-gray-700 flex items-center">
                <i class="fas fa-arrow-left mr-2"></i>Quay lại
            </a>
        </div>

        <form action="{{ route('work-locations.store') }}" method="POST" class="p-6">
            @csrf
            <div class="space-y-6">
                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="any" name="latitude" id="latitude" value="{{ old('latitude', 10.762622) }}" required
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="longitude" id="longitude" value="{{ old('longitude', 106.660172) }}" required
                    ...
                    <div>
                        ...
                        <input type="number" name="radius" id="radius" value="{{ old('radius', 50) }}" required min="10"
                ...
                <div class="flex justify-end pt-4 border-t border-gray-200">
                    ...
                    <button type="submit" class="px-4 py-2 text-sm text-white bg-primary rounded-lg hover:bg-primary-dark">Lưu địa điểm</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    function processSmartInput() {
        ...
        // Regex for Google Maps URL coordinates (fallback for full URLs pasted)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Cố gắng get current location nếu chưa có data post (new check)
        if (!'{{ old("latitude") }}') {
