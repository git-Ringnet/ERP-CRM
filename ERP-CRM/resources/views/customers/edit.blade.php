...
<div class="space-y-4">
    ...
    <form action="{{ route('customers.update', $customer->id) }}" method="POST" x-data="{ 
        ...
        })->toJson() : '[{ name: \'\', first_name: \'\', last_name: \'\', title: \'\', position: \'\', phone: \'\', email: \'\', note: \'\', is_primary: true }]' }},
        addContact() {
                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="name_en" id="name_en" value="{{ old('name_en', $customer->name_en) }}" placeholder="English name"
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="abv_name" id="abv_name" value="{{ old('abv_name', $customer->abv_name) }}" required placeholder="VD: ADG, IIJ..."
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone" value="{{ old('phone', $customer->phone) }}" placeholder="0123456789" pattern="[0-9]+" title="Chỉ được nhập số"
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="am" id="am" value="{{ old('am', $customer->am) }}" placeholder="Tên AM"
                                   class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
                    </div>
                </div>
