                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="code" id="code" value="{{ old('code') }}" required placeholder="VD: KH001"
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    ...
                    <div class="p-4 space-y-3">
                        <div>
                            ...
                            <input type="number" name="debt_limit" id="debt_limit" value="{{ old('debt_limit', 0) }}" min="0" step="1000"
                                   class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
                        <div>
