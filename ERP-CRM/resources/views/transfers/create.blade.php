...
@section('page-title', 'Tạo Phiếu Chuyển Kho')

@section('content')
<div class="bg-white rounded-lg shadow-sm">
    <div class="p-4 border-b border-gray-200 flex justify-between items-center">
        <h2 class="text-lg font-semibold text-gray-900">
            <i class="fas fa-exchange-alt text-purple-500 mr-2"></i>Thông tin phiếu chuyển
        </h2>
        <a href="{{ route('transfers.index') }}" class="text-gray-600 hover:text-gray-900">
            <i class="fas fa-arrow-left mr-1"></i> Quay lại
        </a>
    </div>
    
    <form action="{{ route('transfers.store') }}" method="POST" class="p-4">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
                ...
                <select name="to_warehouse_id" required 
                        class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-lg @error('to_warehouse_id') border-red-500 @enderror">
        ...
        <div class="border-t border-gray-200 pt-4">
            <div class="flex justify-between items-center mb-3">
                <h3 class="text-lg font-semibold text-gray-900">Danh sách sản phẩm chuyển</h3>
        ...
        <div class="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200">
            ...
            <button type="submit" class="px-4 py-2 text-sm text-white bg-purple-500 rounded-lg hover:bg-purple-600">
                <i class="fas fa-save mr-1"></i> Lưu phiếu chuyển
            </button>
        </div>
    </form>
</div>
